# Rapid Prototyping BO Issue Drafts
...
See `backlog.md` for the consolidated view.

1. `RPBO-001` - `01-bootstrap-mock-only-app-shell.md`
2. `RPBO-002` - `02-typed-dashboard-contracts-and-mock-runtime.md`
3. `RPBO-003` - `03-dashboard-design-system-primitives.md`
4. `RPBO-004` - `04-zustand-dashboard-ui-state.md`
5. `RPBO-005` - `05-v0-context-and-design-system-guardrails.md`
6. `RPBO-006` - `06-handoff-pr-expectations.md`
7. `RPBO-007` - `07-jira-delivery-handoff.md`
